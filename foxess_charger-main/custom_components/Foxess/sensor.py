...
SENSORS: tuple[FoxESSChargerSensorDescription, ...] = (
    ...
    FoxESSChargerSensorDescription(
        key="model_code", name="Model", icon="mdi:ev-station",
        value_fn=lambda d: d.get("model_code"),
    ),
    FoxESSChargerSensorDescription(
        key="serial_number", name="Serial Number", icon="mdi:identifier",
...
class FoxESSChargerSensor(CoordinatorEntity, SensorEntity):
    ...
    def __init__(self, coordinator: FoxESSChargerCoordinator,
        ...
        self._attr_device_info = charger_device_info(entry, coordinator.data)
