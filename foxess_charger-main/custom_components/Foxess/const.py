...
REG_FOX_MODEL       = 0x101E  #model code, 4 registers, ASCII (§2.27)
REG_FOX_SERIAL      = 0x1022  #serial number, 16 registers, ASCII (§2.28)
...
REG_OTA_STATUS           = 0x3007  # OTA status
REG_OTA_SIZE             = 0x3008  # OTA firmware size, uint32
